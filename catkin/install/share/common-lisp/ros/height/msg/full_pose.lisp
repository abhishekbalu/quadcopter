...
(cl:defclass <full_pose> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (attitude
    :reader attitude
    :initarg :attitude
    :type height-msg:Attitude
    :initform (cl:make-instance 'height-msg:Attitude))
   (z
    :reader z
    :initarg :z
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <full_pose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'full_pose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name height-msg:<full_pose> is deprecated: use height-msg:full_pose instead.")))
...
(cl:defmethod ang_vel-val ((m <full_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader height-msg:ang_vel-val is deprecated.  Use height-msg:ang_vel instead.")
  (ang_vel m))

(cl:ensure-generic-function 'lin_acc-val :lambda-list '(m))
(cl:defmethod lin_acc-val ((m <full_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader height-msg:lin_acc-val is deprecated.  Use height-msg:lin_acc instead.")
  (lin_acc m))
...
(cl:defmethod z-val ((m <full_pose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader height-msg:z-val is deprecated.  Use height-msg:z instead.")
  (z m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<full_pose>)))
  ...
  (cl:format cl:nil "Header header~%geometry_msgs/Vector3 ang_vel~%geometry_msgs/Vector3 lin_acc~%Attitude attitude~%float64 z~%float64 x~%float64 y~%float64 vx~%float64 vy~%int8 quality~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: height/Attitude~%float64 yaw~%float64 pitch~%float64 roll~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'full_pose)))
  "Returns full string definition for message of type 'full_pose"
  (cl:format cl:nil "Header header~%geometry_msgs/Vector3 ang_vel~%geometry_msgs/Vector3 lin_acc~%Attitude attitude~%float64 z~%float64 x~%float64 y~%float64 vx~%float64 vy~%int8 quality~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%# It is only meant to represent a direction. Therefore, it does not~%# make sense to apply a translation to it (e.g., when applying a ~%# generic rigid transformation to a Vector3, tf2 will only apply the~%# rotation). If you want your data to be translatable too, use the~%# geometry_msgs/Point message instead.~%~%float64 x~%float64 y~%float64 z~%================================================================================~%MSG: height/Attitude~%float64 yaw~%float64 pitch~%float64 roll~%~%~%"))
