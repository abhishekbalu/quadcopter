...
(cl:defmethod cl:initialize-instance :after ((m <DoubleArrayStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DoubleArrayStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ssf_core-msg:<DoubleArrayStamped> is deprecated: use ssf_core-msg:DoubleArrayStamped instead.")))
...
(cl:defmethod data-val ((m <DoubleArrayStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ssf_core-msg:data-val is deprecated.  Use ssf_core-msg:data instead.")
  (data m))
