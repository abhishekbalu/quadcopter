...
#include <HB_Control/ctrl_debug.h>
...
{
public:
    Setpoint() : x(0), y(0), z(5), vx(0), vy(0), vz(0), yaw(0), vyaw(0)
    {}
    float x;
    float y;
    float z;
...
public:
   ...
   // Filter position data
    ...
    HB_Control::ctrl_debug ctrldebug;
...
private:
    ...
    std::vector<float> x;	// position
    std::vector<float> vx;	// velocity
    std::vector<float> ax;	// acceleration
    std::vector<float> fx;	// force
