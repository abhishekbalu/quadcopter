...
LOCAL unsigned short wMultiCastPort = 1040; // Cortex sends frames to this port and associated address
...
LOCAL in_addr MyNicCardAddress = { (10 << 24) + (1 << 16) + (1 << 8) + 100 }; // My local IP address
