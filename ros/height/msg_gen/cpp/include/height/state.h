/* Auto-generated by genmsg_cpp for file /home/pedro/ros/height/msg/state.msg */
...
{
template<class ContainerAllocator> struct IsMessage< ::height::state_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::height::state_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
...
template<class ContainerAllocator> struct HasHeader< ::height::state_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct HasHeader< const ::height::state_<ContainerAllocator> > : public TrueType {};
} // namespace message_traits
} // namespace ros
