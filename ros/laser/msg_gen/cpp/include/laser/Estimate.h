/* Auto-generated by genmsg_cpp for file /home/ubuntu/quadcopter/ros/laser/msg/Estimate.msg */
#ifndef LASER_MESSAGE_ESTIMATE_H
#define LASER_MESSAGE_ESTIMATE_H
#include <string>
#include <vector>
#include <map>
#include <ostream>
...
struct Estimate_ {
  ...
  typedef boost::shared_ptr< ::laser::Estimate_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::laser::Estimate_<ContainerAllocator>  const> ConstPtr;
}; // struct Estimate
typedef  ::laser::Estimate_<std::allocator<void> > Estimate;

typedef boost::shared_ptr< ::laser::Estimate> EstimatePtr;
typedef boost::shared_ptr< ::laser::Estimate const> EstimateConstPtr;


template<typename ContainerAllocator>
std::ostream& operator<<(std::ostream& s, const  ::laser::Estimate_<ContainerAllocator> & v)
{
  ros::message_operations::Printer< ::laser::Estimate_<ContainerAllocator> >::stream(s, "", v);
  return s;}
...
{
template<class ContainerAllocator> struct IsMessage< ::laser::Estimate_<ContainerAllocator> > : public TrueType {};
template<class ContainerAllocator> struct IsMessage< ::laser::Estimate_<ContainerAllocator>  const> : public TrueType {};
template<class ContainerAllocator>
struct MD5Sum< ::laser::Estimate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "9dbe5e1fe0043de2a3e9885989b51e45";
  }

  static const char* value(const  ::laser::Estimate_<ContainerAllocator> &) { return value(); } 
  static const uint64_t static_value1 = 0x9dbe5e1fe0043de2ULL;
  static const uint64_t static_value2 = 0xa3e9885989b51e45ULL;
};

template<class ContainerAllocator>
struct DataType< ::laser::Estimate_<ContainerAllocator> > {
  static const char* value() 
  {
    return "laser/Estimate";
  }
...
template<class ContainerAllocator>
struct Definition< ::laser::Estimate_<ContainerAllocator> > {
  static const char* value() 
  {
...
template<class ContainerAllocator> struct Serializer< ::laser::Estimate_<ContainerAllocator> >
{
...
template<class ContainerAllocator>
struct Printer< ::laser::Estimate_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const  ::laser::Estimate_<ContainerAllocator> & v) 
  {
    s << indent << "name: ";
s << std::endl;
...
#endif // LASER_MESSAGE_ESTIMATE_H
