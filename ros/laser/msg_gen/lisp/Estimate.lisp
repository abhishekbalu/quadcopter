...
(cl:defmethod cl:initialize-instance :after ((m <Estimate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Estimate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser-msg:<Estimate> is deprecated: use laser-msg:Estimate instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:name-val is deprecated.  Use laser-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:position-val is deprecated.  Use laser-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'velocity-val :lambda-list '(m))
(cl:defmethod velocity-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:velocity-val is deprecated.  Use laser-msg:velocity instead.")
  (velocity m))

(cl:ensure-generic-function 'perturbation-val :lambda-list '(m))
(cl:defmethod perturbation-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:perturbation-val is deprecated.  Use laser-msg:perturbation instead.")
  (perturbation m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:orientation-val is deprecated.  Use laser-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'updated-val :lambda-list '(m))
(cl:defmethod updated-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:updated-val is deprecated.  Use laser-msg:updated instead.")
  (updated m))

(cl:ensure-generic-function 'covariance-val :lambda-list '(m))
(cl:defmethod covariance-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:covariance-val is deprecated.  Use laser-msg:covariance instead.")
  (covariance m))

(cl:ensure-generic-function 'sensors-val :lambda-list '(m))
(cl:defmethod sensors-val ((m <Estimate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:sensors-val is deprecated.  Use laser-msg:sensors instead.")
  (sensors m))
