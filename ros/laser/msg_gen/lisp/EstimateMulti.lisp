...
(cl:defclass <EstimateMulti> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (estimates
    :reader estimates
    :initarg :estimates
    :type (cl:vector laser-msg:Estimate)
   :initform (cl:make-array 0 :element-type 'laser-msg:Estimate :initial-element (cl:make-instance 'laser-msg:Estimate)))
   (relative_on
    :reader relative_on
    :initarg :relative_on
    :type cl:fixnum
...
(cl:defmethod cl:initialize-instance :after ((m <EstimateMulti>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EstimateMulti)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser-msg:<EstimateMulti> is deprecated: use laser-msg:EstimateMulti instead.")))
...
(cl:defmethod estimates-val ((m <EstimateMulti>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:estimates-val is deprecated.  Use laser-msg:estimates instead.")
  (estimates m))

(cl:ensure-generic-function 'relative_on-val :lambda-list '(m))
(cl:defmethod relative_on-val ((m <EstimateMulti>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:relative_on-val is deprecated.  Use laser-msg:relative_on instead.")
  (relative_on m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EstimateMulti>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'estimates)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'laser-msg:Estimate))
