...
(cl:defclass <EstimateSingle> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (estimate
    :reader estimate
    :initarg :estimate
    :type laser-msg:Estimate
    :initform (cl:make-instance 'laser-msg:Estimate)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <EstimateSingle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'EstimateSingle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name laser-msg:<EstimateSingle> is deprecated: use laser-msg:EstimateSingle instead.")))
...
(cl:defmethod estimate-val ((m <EstimateSingle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader laser-msg:estimate-val is deprecated.  Use laser-msg:estimate instead.")
  (estimate m))
