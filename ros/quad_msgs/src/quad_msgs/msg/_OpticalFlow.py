...
"""autogenerated by genpy from quad_msgs/OpticalFlow.msg. Do not edit."""
import sys
...
class OpticalFlow(genpy.Message):
  _md5sum = "25aee615ba8ebf42c3f033d1c743dfff"
  _type = "quad_msgs/OpticalFlow"
...
"""
  __slots__ = ['header','ground_distance','velocity_x','velocity_y']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,ground_distance,velocity_x,velocity_y
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_struct_3f.pack(_x.ground_distance, _x.velocity_x, _x.velocity_y))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.ground_distance, _x.velocity_x, _x.velocity_y,) = _struct_3f.unpack(str[start:end])
      return self
