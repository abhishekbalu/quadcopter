...
(cl:defmethod cl:initialize-instance :after ((m <QuadPose>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QuadPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usb_cam-msg:<QuadPose> is deprecated: use usb_cam-msg:QuadPose instead.")))

(cl:ensure-generic-function 'name-val :lambda-list '(m))
(cl:defmethod name-val ((m <QuadPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:name-val is deprecated.  Use usb_cam-msg:name instead.")
  (name m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <QuadPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:position-val is deprecated.  Use usb_cam-msg:position instead.")
  (position m))

(cl:ensure-generic-function 'orientation-val :lambda-list '(m))
(cl:defmethod orientation-val ((m <QuadPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:orientation-val is deprecated.  Use usb_cam-msg:orientation instead.")
  (orientation m))

(cl:ensure-generic-function 'pose_updated-val :lambda-list '(m))
(cl:defmethod pose_updated-val ((m <QuadPose>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:pose_updated-val is deprecated.  Use usb_cam-msg:pose_updated instead.")
  (pose_updated m))
