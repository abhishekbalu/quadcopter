...
(cl:defclass <QuadPoseList> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (poses
    :reader poses
    :initarg :poses
    :type (cl:vector usb_cam-msg:QuadPose)
   :initform (cl:make-array 0 :element-type 'usb_cam-msg:QuadPose :initial-element (cl:make-instance 'usb_cam-msg:QuadPose))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <QuadPoseList>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'QuadPoseList)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usb_cam-msg:<QuadPoseList> is deprecated: use usb_cam-msg:QuadPoseList instead.")))
...
(cl:defmethod poses-val ((m <QuadPoseList>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:poses-val is deprecated.  Use usb_cam-msg:poses instead.")
  (poses m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <QuadPoseList>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'poses)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'usb_cam-msg:QuadPose))
