...
(cl:defmethod cl:initialize-instance :after ((m <detections>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'detections)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name usb_cam-msg:<detections> is deprecated: use usb_cam-msg:detections instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <detections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:header-val is deprecated.  Use usb_cam-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'pos_x-val :lambda-list '(m))
(cl:defmethod pos_x-val ((m <detections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:pos_x-val is deprecated.  Use usb_cam-msg:pos_x instead.")
  (pos_x m))

(cl:ensure-generic-function 'pos_y-val :lambda-list '(m))
(cl:defmethod pos_y-val ((m <detections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:pos_y-val is deprecated.  Use usb_cam-msg:pos_y instead.")
  (pos_y m))

(cl:ensure-generic-function 'size-val :lambda-list '(m))
(cl:defmethod size-val ((m <detections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:size-val is deprecated.  Use usb_cam-msg:size instead.")
  (size m))

(cl:ensure-generic-function 'blob_count-val :lambda-list '(m))
(cl:defmethod blob_count-val ((m <detections>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader usb_cam-msg:blob_count-val is deprecated.  Use usb_cam-msg:blob_count instead.")
  (blob_count m))
