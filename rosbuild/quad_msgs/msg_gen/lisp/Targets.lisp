...
(cl:defclass <Targets> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (targets
    :reader targets
    :initarg :targets
    :type (cl:vector quad_msgs-msg:State)
   :initform (cl:make-array 0 :element-type 'quad_msgs-msg:State :initial-element (cl:make-instance 'quad_msgs-msg:State))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <Targets>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Targets)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name quad_msgs-msg:<Targets> is deprecated: use quad_msgs-msg:Targets instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Targets>))
...
(cl:defmethod targets-val ((m <Targets>))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Targets>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'targets)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'quad_msgs-msg:State))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Targets>)))
  ...
  "24088b31832b9fb955ef238b9c9a7bba")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Targets)))
  "Returns md5sum for a message object of type 'Targets"
  "24088b31832b9fb955ef238b9c9a7bba")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Targets>)))
  ...
  (cl:format cl:nil "Header header~%State[] targets~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: quad_msgs/State~%geometry_msgs/Point position~%geometry_msgs/Point velocity~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Targets)))
  "Returns full string definition for message of type 'Targets"
  (cl:format cl:nil "Header header~%State[] targets~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: quad_msgs/State~%geometry_msgs/Point position~%geometry_msgs/Point velocity~%~%================================================================================~%MSG: geometry_msgs/Point~%# This contains the position of a point in free space~%float64 x~%float64 y~%float64 z~%~%~%"))
